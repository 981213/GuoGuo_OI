 ...
 * 0            无          I am guilty
 * 1                        I am not guilty
 * 2            students[XXXX]  XXXX is guilty
 * 3            students[XXXX]  XXXX is not guilty
 * 4            0~6         Monday~Sunday
 * 5            无          废话
 */
...
void test_tf()
{
    ...
    for(int i=0;i<p;i++)
    {
        ...
        {
            case 0:
            if(((ifstudents[words[i][0]]==0)&&(guilty_temp==100))||((ifstudents[words[i][0]]==1)&&(guilty_temp==words[i][0])))
            {
                guilty_temp=words[i][0];
                ifstudents[words[i][0]]=1;
                iftrue=1;
            }
            break;
            case 1:
            if((ifstudents[words[i][0]]==0)||((ifstudents[words[i][0]]==2)))
            {
                ifstudents[words[i][0]]=2;
                iftrue=1;
            }
            break;
            case 2:
            ...
            break;
            case 4:
            if((!studentstf[words[i][0]])&&((weekday==7)||(weekday==words[i][2])))
            {
                weekday=words[i][2];
                ifweek[words[i][2]]=1;
                iftrue=1;
            }
            else if ((studentstf[words[i][0]])&&(ifweek[words[i][2]]!=1))
            {
                ifweek[words[i][2]]=0;
                iftrue=1;
            }
